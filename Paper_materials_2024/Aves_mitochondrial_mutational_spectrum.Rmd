...
control <- glsControl(maxIter = 10000, msMaxIter=40000, returnObject = TRUE)
pgls_nonf = gls(GhAhSkew~flight_num,
                data=df_flight, correlation=corLambda, control = control)
summary(pgls_nonf)
