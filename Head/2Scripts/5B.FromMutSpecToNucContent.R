...
{
  plot(Final[Final$InitGenome == InitGenome & Final$MutSpecProb == 'average fish',]$Gener,Final[Final$InitGenome == InitGenome & Final$MutSpecProb == 'average fish',]$FrA, ylim = c(0,0.6), pch = '.', col = ColorA, main = '', xlab = '', ylab = ''); par(new=TRUE)
  plot(Final[Final$InitGenome == InitGenome & Final$MutSpecProb == 'average fish',]$Gener,Final[Final$InitGenome == InitGenome & Final$MutSpecProb == 'average fish',]$FrT, ylim = c(0,0.6), pch = '.', col = ColorT, main = '', xlab = '', ylab = ''); par(new=TRUE)
  plot(Final[Final$InitGenome == InitGenome & Final$MutSpecProb == 'average fish',]$Gener,Final[Final$InitGenome == InitGenome & Final$MutSpecProb == 'average fish',]$FrG, ylim = c(0,0.6), pch = '.', col = ColorG, main = '', xlab = '', ylab = ''); par(new=TRUE)
  plot(Final[Final$InitGenome == InitGenome & Final$MutSpecProb == 'average fish',]$Gener,Final[Final$InitGenome == InitGenome & Final$MutSpecProb == 'average fish',]$FrC, ylim = c(0,0.6), pch = '.', col = ColorC, main = 'Average fish, neutral equilibrium, heavy chain', xlab = '', ylab = ''); par(new=TRUE)
}
