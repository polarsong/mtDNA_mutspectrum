...
plot(log2(AGG$GenerationLength_d),AGG$FrA, col = 'gray', ylim = c(0,0.6), xlab = 'log2(GT)', main = 'FrA', cex = 2); abline(h =0.25, lt = 2, col = 'red')
plot(log2(AGG$GenerationLength_d),AGG$FrT, col = 'blue', ylim = c(0,0.6), xlab = 'log2(GT)', main = 'FrT', cex = 2); abline(h =0.25, lt = 2, col = 'red')
plot(log2(AGG$GenerationLength_d),AGG$FrG, col = 'green', ylim = c(0,0.6), xlab = 'log2(GT)', main = 'FrG', cex = 2); abline(h =0.25, lt = 2, col = 'red')
plot(log2(AGG$GenerationLength_d),AGG$FrC, col = 'cyan', ylim = c(0,0.6), xlab = 'log2(GT)', main = 'FrC', cex = 2); abline(h =0.25, lt = 2, col = 'red')
...
{ # i = 1
  ...
  main = VecOfGenes[i]
  plot(log2(OneGene$GenerationLength_d),OneGene$FrA, col = 'gray', main = main, ylim = c(0,0.7), xlab = 'log2(GT)') # a bit negative
  plot(log2(OneGene$GenerationLength_d),OneGene$FrT, col = 'blue', main = main, ylim = c(0,0.7), xlab = 'log2(GT)') # a bit negative
  plot(log2(OneGene$GenerationLength_d),OneGene$FrG, col = 'green', main = main, ylim = c(0,0.7), xlab = 'log2(GT)') # a bit negative
  plot(log2(OneGene$GenerationLength_d),OneGene$FrC, col = 'cyan', main = main, ylim = c(0,0.7), xlab = 'log2(GT)') # a bit negative
}
dev.off()
