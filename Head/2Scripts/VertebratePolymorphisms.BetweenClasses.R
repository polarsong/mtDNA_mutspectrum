...
MUT <- MUT %>% filter(AncestorCodon   %in% VecOfSynFourFoldDegenerateSites, DescendantCodon %in% VecOfSynFourFoldDegenerateSites); nrow(MUT) 

##### FILTER: Gene
table(MUT$Gene)
MUT <- MUT %>% filter(Gene == "CytB"); nrow(MUT)
