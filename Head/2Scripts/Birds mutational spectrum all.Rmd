...
First we decided to look at birds Trophic level
***
``` {r}
...
```
<br>
According to our boxplots, we can see that carnivore and omnivore birds have more guanine and thymine in their mtDNA
<br>
##### 3.2 Realm 
...
```
<br>
We can see that Antarctic birds have more guanine and thymine in their mtDNA
<br>
#### 4. PCA analysis
<br> 
To see, that increase of G and T is driven by mutagenesis, not natural selection, we made a PCA analysis
<br>
***
```{r}
...
```
<br> 
From PCA biplot we can see two orthogonal axes: A -> G mutations, C -> T mutations. This means that all the changes in birds mtDNA are driven by mutagenesis 
<br>
#### 5. PGLS analysis
To do statistic, we constructed a phylogenetic tree claculated PGLS for each ecology and genes characteristic
***
```{r}
