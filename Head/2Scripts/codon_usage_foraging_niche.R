...
violin_c = ggplot(final, aes(x = foraging_niche, y = med_c)) +
  geom_violin() + 
  theme(axis.text.x = element_text(angle = 90)) 
violin_a = ggplot(final, aes(x = foraging_niche, y = med_a)) +
  geom_violin() + 
  theme(axis.text.x = element_text(angle = 90))
box_c = ggplot(final, aes(x = foraging_niche, y = med_c)) +
  geom_boxplot() + 
  theme(axis.text.x = element_text(angle = 90))
box_a = ggplot(final, aes(x = foraging_niche, y = med_a)) +
  geom_boxplot() + 
  theme(axis.text.x = element_text(angle = 90))
